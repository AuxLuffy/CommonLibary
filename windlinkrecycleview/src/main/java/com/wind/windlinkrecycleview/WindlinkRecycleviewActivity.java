...
/**
 * 酷炫的Recycleview双列表联动与悬停
 * @Author 李巷阳
 * Created at 2017/9/22 14:38
 */
public class WindlinkRecycleviewActivity extends AppCompatActivity implements CheckListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_windlinkrecyclerview);
        initView();
        initData();
