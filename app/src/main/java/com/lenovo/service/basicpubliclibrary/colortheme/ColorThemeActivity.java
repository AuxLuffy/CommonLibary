...
import com.lenovo.service.basicpubliclibrary.colortheme.setter.ViewGroupSetter;

import java.util.ArrayList;
import java.util.List;

public class ColorThemeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.second_btn).setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ColorThemeActivity.this,
