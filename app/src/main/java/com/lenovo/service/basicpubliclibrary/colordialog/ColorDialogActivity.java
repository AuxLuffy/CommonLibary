package com.lenovo.service.basicpubliclibrary.colordialog;
...
import com.lenovo.service.basicpubliclibrary.colordialog.view.ColorDialog;
import com.lenovo.service.basicpubliclibrary.colordialog.view.PromptDialog;
...
public class ColorDialogActivity extends AppCompatActivity {
    ...
    public void showTextDialog(View view) {
        ...
        dialog.setPositiveListener(getString(R.string.text_iknow), new ColorDialog.OnPositiveListener() {
            ...
            public void onClick(ColorDialog dialog) {
                dialog.dismiss();
                Toast.makeText(ColorDialogActivity.this, dialog.getPositiveText().toString(), Toast.LENGTH_SHORT).show();
            }
        }).show();
    }
    ...
    public void showPicDialog(View v) {
        ...
        .setNegativeListener(getString(R.string.cancel), new ColorDialog.OnNegativeListener() {
            @Override
            public void onClick(ColorDialog dialog) {
                Toast.makeText(ColorDialogActivity.this, dialog.getNegativeText().toString(), Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        }).show();
    }
