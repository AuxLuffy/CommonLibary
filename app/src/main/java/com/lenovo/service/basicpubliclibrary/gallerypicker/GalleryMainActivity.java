package com.lenovo.service.basicpubliclibrary.gallerypicker;
...
import com.lenovo.service.basicpubliclibrary.gallerypicker.loader.FrescoImageLoader;
import com.lenovo.service.basicpubliclibrary.gallerypicker.loader.GlideImageLoader;
import com.lenovo.service.basicpubliclibrary.gallerypicker.loader.PicassoImageLoader;
...
//                galleryConfig.getBuilder().isOpenCamera(true).build();
    ...
    private void initPermissions() {
        if (ContextCompat.checkSelfPermission(mActivity, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            Log.i(TAG, "不需要授权 ");
            GalleryPick.getInstance().setGalleryConfig(galleryConfig).open(GalleryMainActivity.this);
        }
    }
