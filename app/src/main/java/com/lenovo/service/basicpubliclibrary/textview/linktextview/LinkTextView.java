 ...
 * <ul>
 * <li>可以通过 {@link com.lenovo.service.basicpubliclibrary.R.styleable#LinkTextView} 中的属性设置链接的样式</li>
 ...
 * </ul>
 */
public class LinkTextView extends TextView implements OnSpanClickListener, SpanTouchFix {
    private static final String TAG = "LinkTextView";
    private static final int MSG_CHECK_DOUBLE_TAP_TIMEOUT = 1000;
    public static int AUTO_LINK_MASK_REQUIRED = Linkify.PHONE_NUMBERS | Linkify.EMAIL_ADDRESSES | Linkify.WEB_URLS;
    ...
    public LinkTextView(Context context) {
        this(context, null);
        mLinkBgColor = null;
        mLinkTextColor = ContextCompat.getColorStateList(context, R.color.text_color_child);
    }
