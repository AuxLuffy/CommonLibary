package com.lenovo.service.basicpubliclibrary.hencoder.hencoderpracticedraw4;
...
public class MainActivity extends AppCompatActivity {
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_camera_rotate_fixed, R.string.title_camera_rotate_fixed, R.layout.practice_camera_rotate));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_view4);
