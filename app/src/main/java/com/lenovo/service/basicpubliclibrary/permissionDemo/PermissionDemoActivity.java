package com.lenovo.service.basicpubliclibrary.permissionDemo;
...
import static com.lenovo.service.basicpubliclibrary.permissionDemo.PermissionDemoActivity.CALENDAR_CODE;
import static com.lenovo.service.basicpubliclibrary.permissionDemo.PermissionDemoActivity.LOCATION_CODE;
import static com.lenovo.service.basicpubliclibrary.permissionDemo.PermissionDemoActivity.SENSORS_CODE;
...
public class PermissionDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Permissions4M.get(PermissionDemoActivity.this)
        ...
        mOneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Permissions4M
                        .get(PermissionDemoActivity.this)
                        .requestSync();
            }
        });
        ...
        mManagerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(PermissionsPageManager.getIntent(PermissionDemoActivity.this));
            }
        });
        ...
        mPermissionPageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(PermissionsPageManager.getSettingIntent(PermissionDemoActivity.this));
            }
        });
                ...
                Permissions4M.get(PermissionDemoActivity.this)
                        ...
                        .requestPage(new Wrapper.PermissionPageListener() {
                            ...
                            public void pageIntent(final Intent intent) {
                                new AlertDialog.Builder(PermissionDemoActivity.this)
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[]
            grantResults) {
        Permissions4M.onRequestPermissionsResult(PermissionDemoActivity.this, requestCode, grantResults);
