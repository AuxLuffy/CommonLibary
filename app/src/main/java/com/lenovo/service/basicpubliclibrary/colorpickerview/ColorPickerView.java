package com.lenovo.service.basicpubliclibrary.colorpickerview;
...
public class ColorPickerView extends FrameLayout {
    ...
    private void onCreate() {
        ...
        FrameLayout.LayoutParams wheelParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
