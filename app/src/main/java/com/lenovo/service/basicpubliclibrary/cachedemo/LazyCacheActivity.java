package com.lenovo.service.basicpubliclibrary.cachedemo;
...
public class LazyCacheActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view= View.inflate(this,R.layout.activity_lazy_cache,null);
        setContentView(view);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.buttonSave) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            String area_strs = FileUtil.readAssets(LazyCacheActivity.this, "province.json");
            ...
            Toast.makeText(LazyCacheActivity.this, "加载数据用时:" + (System.currentTimeMillis() - lastTime) + "毫秒", Toast.LENGTH_SHORT).show();
