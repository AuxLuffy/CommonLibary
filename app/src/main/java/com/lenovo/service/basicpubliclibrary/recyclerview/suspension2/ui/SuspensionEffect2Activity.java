package com.lenovo.service.basicpubliclibrary.recyclerview.suspension2.ui;
...
import com.lenovo.service.basicpubliclibrary.recyclerview.suspension2.adapter.SuspensionAdapter;
import com.lenovo.service.basicpubliclibrary.recyclerview.suspension2.listener.GroupListener;
import com.lenovo.service.basicpubliclibrary.recyclerview.suspension2.view.SuspensionItemDecoration;
 ...
 */
public class SuspensionEffect2Activity extends AppCompatActivity {
    //今天的主角RecyclerView
    private RecyclerView recyclerView;
    private Context context = SuspensionEffect2Activity.this;
    ...
    private void initView() {
        ...
        suspensionAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(SuspensionEffect2Activity.this, "点击了条目" + (position + 1), Toast.LENGTH_SHORT).show();
