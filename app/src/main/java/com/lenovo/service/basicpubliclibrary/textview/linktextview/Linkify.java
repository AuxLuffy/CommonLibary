...
public class Linkify {
     ...
     */
    public static final boolean addLinks(Spannable text, int mask, ColorStateList linkColor, ColorStateList bgColor, OnSpanClickListener l) {
        if (mask == 0) {
            return false;
        }
     ...
     * LinkMovementMethod.
     */
    public static final boolean addLinks(TextView text, int mask, ColorStateList linkColor, ColorStateList bgColor, OnSpanClickListener l) {
        if (mask == 0) {
            return false;
        }
    ...
    private static final void applyLink(String url, int start, int end, Spannable text, final ColorStateList linkColor, final ColorStateList bgColor, OnSpanClickListener l) {
