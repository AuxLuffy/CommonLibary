package com.lenovo.service.basicpubliclibrary.recyclerview.staggeredtimeline.timeline3;
...
import com.lenovo.service.basicpubliclibrary.recyclerview.staggeredtimeline.itemdecoration.DotItem2Decoration;
 ...
 */
public class DotTimeLine2Activity extends AppCompatActivity {
    RecyclerView mRecyclerView;

    List<Event> mList = new ArrayList<>();
    DotTimeLineAdapter mAdapter;
    DotItem2Decoration mItemDecoration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItemDecoration = new DotItem2Decoration
                .Builder(this)
                .setOrientation(DotItem2Decoration.VERTICAL)//if you want a horizontal item decoration,remember to set horizontal orientation to your LayoutManager
                .setItemStyle(DotItem2Decoration.STYLE_DRAW)
