package com.lenovo.service.basicpubliclibrary.recyclerview.item.decoration.line.ui;
...
public class DecorationActivity extends AppCompatActivity {
    ...
    private Context context=DecorationActivity.this;
    //图片资源
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("RecyclerView的条目分割线");
        getSupportActionBar().setSubtitle("直线分割");
    ...
    private void initView() {
        ...
        dividerItemDecoration.setColor(getResources().getColor(R.color.colorAccent));
        dividerItemDecoration.setDividerHeight(ScreenUtils.dp2px(context, 1));
        dividerItemDecoration.setFirstItemHasDivider(false);
        //添加分割线
        ...
        weatherAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(DecorationActivity.this, "点击了条目" + (position+1), Toast.LENGTH_SHORT).show();
