    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                Log.e("tag", String.format("items=%s, offset=%s", items.size(), offset));
                Log.e("tag", "selectedIndex=" + selectedIndex);
    ...
    private class ScrollerTask implements Runnable {
        ...
        public void run() {
            ...
            if (initialY - newY == 0) { // stopped
                ...
                Log.e("tag", "initialY: " + initialY + ", remainder: " + remainder + ", divided: " + divided);
                if (remainder == 0) {
