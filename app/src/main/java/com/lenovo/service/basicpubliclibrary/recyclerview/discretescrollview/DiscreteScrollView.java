package com.lenovo.service.basicpubliclibrary.recyclerview.discretescrollview;
...
import com.lenovo.service.basicpubliclibrary.recyclerview.discretescrollview.transform.DiscreteScrollItemTransformer;
import com.lenovo.service.basicpubliclibrary.recyclerview.discretescrollview.util.ScrollListenerAdapter;
...
public class DiscreteScrollView extends RecyclerView {
    ...
    public void setLayoutManager(LayoutManager layout) {
        if (layout instanceof DiscreteScrollLayoutManager) {
            ...
            throw new IllegalArgumentException("ou should not set LayoutManager on DiscreteScrollView.class instance. Library uses a special one. Just don\\'t call the method.");
        }
    }
