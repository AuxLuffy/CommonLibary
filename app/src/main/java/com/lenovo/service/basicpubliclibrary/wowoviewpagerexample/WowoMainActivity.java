...
import com.lenovo.service.basicpubliclibrary.wowoviewpagerexample.gif.GIFActivity;
import com.lenovo.service.basicpubliclibrary.wowoviewpagerexample.svg.SVGActivity;


public class WowoMainActivity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_wowo);
