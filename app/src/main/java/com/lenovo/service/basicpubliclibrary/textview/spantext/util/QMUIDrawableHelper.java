package com.lenovo.service.basicpubliclibrary.textview.spantext.util;
...
public class QMUIDrawableHelper {
    ...
    Drawable getVectorDrawable(Context context, @DrawableRes int resVector) {
        try {
            ...
            LogUtil.e("Error in getVectorDrawable. resVector=" + resVector + ", resName=" + context.getResources().getResourceName(resVector) + e.getMessage());
            return null;
        }
    }
