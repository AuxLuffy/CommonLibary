package com.lenovo.service.basicpubliclibrary.recyclerview.item.decoration.rankinglist.ui;
...
import com.lenovo.service.basicpubliclibrary.recyclerview.item.decoration.rankinglist.view.RankingListItemDecoration;
...
/**
 * @description: 利用ItemDecoration实现排行榜效果
 * @author:袁东华
...
public class RankingListActivity extends AppCompatActivity {
    ...
    private Context context=RankingListActivity.this;
    //图片资源
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("利用ItemDecoration实现排行榜效果");
    ...
    private void initView() {
        ...
        //创建时光轴
        RankingListItemDecoration rankingListItemDecoration = new RankingListItemDecoration();
        rankingListItemDecoration.setColor(getResources().getColor(R.color.colorAccent));
        rankingListItemDecoration.setItemViewLeft(ScreenUtils.dp2px(this,60));
        rankingListItemDecoration.setDividerHeight(ScreenUtils.dp2px(this,0));
        rankingListItemDecoration.setIcon(new Bitmap[]{
                        BitmapFactory.decodeResource(getResources(),R.drawable.first),
                        BitmapFactory.decodeResource(getResources(),R.drawable.second),
                        BitmapFactory.decodeResource(getResources(),R.drawable.third)}
                );


//        timeLineItemDecoration.setStrokeWidth(ScreenUtils.dp2px(this,4));
        //添加分割线
        recyclerView.addItemDecoration(rankingListItemDecoration);
        ...
        weatherAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(RankingListActivity.this, "点击了条目" + (position+1), Toast.LENGTH_SHORT).show();
