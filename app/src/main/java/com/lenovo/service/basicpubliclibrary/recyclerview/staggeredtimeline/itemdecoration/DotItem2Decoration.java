package com.lenovo.service.basicpubliclibrary.recyclerview.staggeredtimeline.itemdecoration;
...
public class DotItem2Decoration extends RecyclerView.ItemDecoration {
    ...
    public DotItem2Decoration(Context context) {
        mContext = context;
    ...
    public static class Builder {
        private Context mContext;
        private DotItem2Decoration itemDecoration;

        public Builder(Context context) {
            this.mContext = context;
            itemDecoration = new DotItem2Decoration(context);
        }
        ...
        public DotItem2Decoration create() {
