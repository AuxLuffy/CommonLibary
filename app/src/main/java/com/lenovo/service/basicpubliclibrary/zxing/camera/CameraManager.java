 ...
 */
package com.lenovo.service.basicpubliclibrary.zxing.camera;
...
import com.lenovo.service.basicpubliclibrary.zxing.camera.open.OpenCamera;
import com.lenovo.service.basicpubliclibrary.zxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            int width = App.widthPixels * 2 / 3;
            int height = width;
            int leftOffset = (screenResolution.x - width) / 2;
            int topOffset = (screenResolution.y - height) / 2 - (int) convertDip2Pixel(50);
