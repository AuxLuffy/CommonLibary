package com.lenovo.service.basicpubliclibrary.recyclerview.suspension.view;
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (currentGroupName == null || TextUtils.equals(lastGroupName, currentGroupName)) {
                ...
                LogUtil.e("lastGroupName:" + lastGroupName);
                LogUtil.e("currentGroupName:" + currentGroupName);
            } else {
                //绘制悬浮栏
                //判断悬浮栏的底部
                ...
                if (childAdapterPosition + 1 < itemCount) {
                    ...
                    LogUtil.e("nextGroupName:" + nextGroupName);
