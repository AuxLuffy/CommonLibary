package com.lenovo.service.basicpubliclibrary.notificoation;
...
import com.lenovo.service.basicpubliclibrary.notificoation.base.BaseActivity;

/**
 * Created by lenovo on 2017/9/26.
 */

public class NotificoationActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notificoaction);
        initView();
        initNotify();
    }
...
//		notification.flags = Notification.FLAG_AUTO_CANCEL; //在通知栏上点击此通知后自动清除此通知
        ...
        Intent resultIntent = new Intent(this, NotificoationActivity.class);
