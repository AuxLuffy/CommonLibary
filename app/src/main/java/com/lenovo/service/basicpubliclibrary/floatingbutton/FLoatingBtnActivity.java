package com.lenovo.service.basicpubliclibrary.floatingbutton;
...
import com.lenovo.service.basicpubliclibrary.floatingbutton.util.FloatingActionsMenu;

/**
 * created by cx in 2017.9.15
 * 此动画来自github
 */
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.pink_icon).setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        Toast.makeText(FLoatingBtnActivity.this, "Clicked pink Floating Action Button", Toast.LENGTH_SHORT).show();
      }
    });
